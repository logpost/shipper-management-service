...
import { whitelistUpdateAccountProfileDTO } from '../entities/dtos/shipper.dto'
...
const validUpdatedFields = (profile: whitelistUpdateAccountProfileDTO, whitelist_key: string): string[] => {
